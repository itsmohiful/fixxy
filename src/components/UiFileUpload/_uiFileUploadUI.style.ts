...
export const _uiFileUploadStyle: SxProps = {
  position: 'relative',
  width: '100%',
  height: 40,
...
export const _uiFileUploadTickIconStyle = { fill: '#00860A' };
export const _uiFileProfilePicUploadStyle: SxProps = {
  width: '140px',
  height: '170px',
  display: 'flex',
...
export const _uiFileUploadProgressBox = (uploadedAmount: number) => {
  return {
